...
class RadarSatellite:
    ...
    async def async_generate_images(self,path:str = ""):
        await self.async_create_animation("imsradar.gif",self.imsradar_images,path)
        await self.async_create_animation("radar.gif",self.radar_images,path)
        await self.async_create_animation("middle_east.gif",self.middle_east_satellite_images,path)
        await self.async_create_animation("europe.gif",self.europe_satellite_images,path)
 

    async def async_create_animation(self, animated_file:str, images: list,path:str ):
        '''
